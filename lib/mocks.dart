...
abstract class Mocks {
  ...
  Sight(
    ...
    lon: 37.735425,
    url:
        'https://mytyshimuseum.ru/wp-content/uploads/Zal-19-vek-2-1.jpeg',
    details:
        'Центральный музей городского округа Мытищи. Открыт в 1962 году.',
  ...
  Sight(
    ...
    lon: 37.730916,
    url:
        'https://avatars.mds.yandex.net/get-altay/4398559/2a00000181b14c1ff7099db35afff1bef259/XXXL',
    details:
  ...
  Sight(
    ...
    lon: 37.725245,
    url:
        'https://static.yakitoriya.ru/media/cache/60/15/60158655420e2922294478c35d86ba77.png',
    details:
