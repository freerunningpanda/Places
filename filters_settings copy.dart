...
abstract class FiltersSettings {
  static const double rangeStart = 2000;
  static const double rangeEnd = 8000;
  ...
  static RangeValues rangeValues = const RangeValues(rangeStart, rangeEnd);

  final _rangeValues = rangeValues;
